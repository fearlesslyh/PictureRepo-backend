...
import com.lyh.picturerepo.shared.auth.annotation.SaSpaceCheckPermission;
import com.lyh.picturerepo.shared.auth.model.SpaceUserPermissionConstant;
...
public class SpaceUserController {
    ...
    public BaseResponse<SpaceUser> getSpaceUser(@RequestBody SpaceUserQueryRequest spaceUserQueryRequest) {
        ...
        // 查询数据库
        SpaceUser spaceUser = spaceUserDomainService.getOne(spaceUserDomainService.getQueryWrapper(spaceUserQueryRequest));
