package com.lyh.picturerepo.domain.picture.service.impl;
...
//            }
    ...
    public void reviewPicture(PictureReview pictureReview, User loginUser) {
        ...
        boolean result = pictureRepository.updateById(currentPicture);
    ...
    public void batchEditPictureMetadata(PictureEditByBatch pictureEditByBatch, Long spaceId, Long loginUserId) {
        ...
        for (int i = 0; i < pictureList.size(); i += batchSize) {
            ...
            CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
                ...
                boolean result = pictureRepository.updateBatchById(batch);
                if (!result) {
