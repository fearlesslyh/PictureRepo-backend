...
public class SpaceController {
    ...
    public BaseResponse<Boolean> updateSpace(@RequestBody SpaceUpdate spaceUpdateRequest,
                                             HttpServletRequest request) {
    ...
    @AuthorityCheck(mustHaveRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<Space>> listSpaceByPage(@RequestBody SpaceQuery spaceQueryRequest) {
    ...
    public BaseResponse<Page<SpaceVO>> listSpaceVOByPage(@RequestBody SpaceQuery spaceQueryRequest,
                                                         HttpServletRequest request) {
        long current = spaceQueryRequest.getCurrent();
        long size = spaceQueryRequest.getPageSize();
        // 限制爬虫
     ...
     */
    @PostMapping("/edit")
    public BaseResponse<Boolean> editSpace(@RequestBody SpaceEdit spaceEditRequest, HttpServletRequest request) {
